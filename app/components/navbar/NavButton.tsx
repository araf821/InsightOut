...
const NavButton: FC<NavButtonProps> = ({ icon: Icon, title, onClick }) => {
  return (
    <button
      onClick={onClick}
      className="group relative flex w-full items-center justify-center gap-2 overflow-hidden bg-rose-600 p-3 text-lg text-zinc-900 outline-none transition-all duration-200 hover:scale-[1.01] hover:outline-rose-600 focus:ring-2 focus:ring-rose-600 md:text-xl lg:gap-4 lg:text-2xl"
    >
      <Icon />
