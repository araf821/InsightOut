  ...
  return (
    <Container>
      <div className="pb-12 pt-4">
        ...
        {/* Cards container */}
        <div className="mt-4 bg-secondary flex flex-col gap-4 md:flex-row md:justify-between md:border md:border-neutral-200 md:p-2 md:shadow-lg lg:gap-8 lg:p-3 xl:p-4">
