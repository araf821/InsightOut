...
const Footer = () => {
  return (
    <footer className="text-white w-full bg-gray-800 flex flex-col items-center justify-center px-8 pt-10 pb-8">
      ...
      <div className="text-center flex flex-col items-center">
        ...
        <div className="flex flex-row items-center mt-6 sm:mt-10 mb-4 sm:mb-8">
          <div className="border-gray-500 border-t-[8px] rounded-full w-2" />
          <div className="border-gray-500 border-t-[2px] w-[200px] sm:w-[325px] md:w-[450px] lg:w-[600px]" />
          <div className="border-gray-500 border-t-[8px] rounded-full w-2" />
        </div>
