...
const SidebarButton: FC<SidebarButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="group relative w-full overflow-hidden rounded-lg border-2 border-zinc-800 bg-bg p-3 font-medium text-gray-600 shadow-inner outline-none outline-offset-4 ring-offset-zinc-800 hover:outline-2 hover:outline-zinc-800 focus:outline-2 focus:outline-zinc-800"
    >
