...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      type="button"
      className={` group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-sm border-2 outline-none ring-offset-2 transition-all duration-300  focus:ring-2 
      ${
        special
      ...
      ${
        small
          ? "px-2 py-1 text-sm md:text-base lg:text-lg font-semibold"
