...
const StatCard: FC<StatCardProps> = ({
  ...
  return (
    <div
      className={`${className} group relative w-full origin-center rounded-md bg-transparent p-2 shadow-xl`}
    >
      {/* Background */}
      <div
      ...
      {/* content */}
      <div className="flex gap-4 rounded-md bg-zinc-800 px-3 py-2 text-white transition duration-300">
